...
const products = [
  product('vestido-01', 'Vestido Longo Miragem Bege', 'vestidos', 229.90, 299.90, 'Bege', ['Bege', 'Preto'], 'Elegância e movimento em uma peça de silhueta alongada. A estampa delicada e o caimento fluido criam uma composição feminina e sofisticada, perfeita para ocasiões especiais.', 0, true, true),
  product('vestido-02', 'Vestido Midi Aurora Vinho', 'vestidos', 189.90, 249.90, 'Vinho', ['Vinho', 'Preto'], 'Com uma tonalidade vinho marcante e silhueta alongada, o Vestido Aurora traduz sofisticação e modernidade. Uma escolha elegante para produções que pedem presença e refinamento.', 1, true, true),
  product('vestido-03', 'Vestido Longo Lírio Preto', 'vestidos', 159.90, null, 'Preto', ['Preto', 'Branco'], 'O acabamento acetinado confere luminosidade e sofisticação à peça. Com comprimento longo e modelagem que acompanha delicadamente o corpo, é ideal para ocasiões em que elegância é essencial.', 2, true, false),
  product('vestido-04', 'Vestido Acetinado Íris Rosa', 'vestidos', 279.90, 339.90, 'Rosa', ['Rosa', 'Preto'], 'Leveza e sofisticação definem o Vestido Celeste. O efeito plissado acrescenta movimento à silhueta, enquanto a tonalidade bege proporciona uma estética delicada e atemporal.', 3, false, true),
  product('vestido-05', 'Vestido Linho Serena Branco', 'vestidos', 149.90, null, 'Branco', ['Branco', 'Preto'], 'Um clássico indispensável para o guarda-roupa. A modelagem elegante e a tonalidade preta criam uma peça versátil, sofisticada e fácil de transitar entre diferentes ocasiões.', 4, false, false),
  product('vestido-06', 'Vestido Envelope Marrom', 'vestidos', 199.90, 229.90, 'Marrom', ['Marrom', 'Bege'], 'Minimalista e sofisticado, este vestido combina silhueta fluida com cintura suavemente marcada. Uma proposta atemporal para produções elegantes e contemporâneas.', 5, false, false),
  product('vestido-07', 'Vestido Canelado Noa Marrom', 'vestidos', 89.90, 119.90, 'Marrom', ['Marrom', 'Preto'], 'Em uma tonalidade terracota sofisticada, a peça apresenta caimento elegante e silhueta feminina. Perfeita para composições modernas com personalidade.', 6, false, false),
  product('vestido-08', 'Vestido Plissado Celeste Bege', 'vestidos', 319.90, null, 'Bege', ['Bege', 'Marrom'], 'A estampa animal print ganha uma leitura sofisticada nesta modelagem midi. Uma peça de personalidade, ideal para transformar produções e criar looks marcantes.', 7, false, true),
  product('vestido-09', 'Vestido Longo Eclipse', 'vestidos', 179.90, 219.90, 'Branco', ['Branco', 'Preto'], 'Delicadeza e sofisticação em uma silhueta longa. A textura trabalhada e o acabamento leve valorizam a peça, criando uma proposta elegante para ocasiões especiais.', 8, false, false),
  product('blusa-01', 'Blusa Seda Essencial Bege', 'blusas', 129.90, 169.90, 'Bege', ['Bege', 'Marrom'], 'Sofisticada e versátil, a Blusa Seda Essencial apresenta uma estética clean e elegante. O tom bege facilita combinações e permite transitar com facilidade entre produções casuais e refinadas.', 9, true, true),
  product('blusa-02', 'Blusa Decote V Rubi', 'blusas', 99.90, null, 'Vinho', ['Vinho', 'Preto'], 'Delicada e contemporânea, a Blusa Nara aposta no comprimento cropped e na tonalidade rosa para criar uma proposta feminina e atual. Ideal para combinações leves e modernas.', 10, true, false),
  product('blusa-03', 'Blusa Cropped Nara Rosa', 'blusas', 79.90, 99.90, 'Rosa', ['Rosa', 'Branco'], 'Delicada e contemporânea, a Blusa Nara aposta no comprimento cropped e na tonalidade rosa para criar uma proposta feminina e atual. Ideal para combinações leves e modernas.', 11, true, true),
  product('blusa-04', 'Blusa Linho Horizonte Bege', 'blusas', 159.90, null, 'Bege', ['Bege', 'Branco'], 'Com estética natural e atemporal, traz leveza e sofisticação para o guarda-roupa. O tom bege facilita combinações elegantes em diferentes ocasiões.', 12, false, false),
  product('blusa-05', 'Blusa Ombro Único Vitta Preta', 'blusas', 189.90, 239.90, 'Preto', ['Preto', 'Vinho'], 'Um design assimétrico que transforma o clássico preto em uma peça de destaque. Sofisticada e moderna, perfeita para produções mais marcantes.', 13, false, true),
  product('blusa-06', 'Blusa Tricot Amêndoa', 'blusas', 219.90, null, 'Marrom', ['Marrom', 'Bege'], 'A textura do tricot acrescenta charme e sofisticação ao visual, enquanto a tonalidade amêndoa permite combinações delicadas e versáteis', 14, false, false),
  product('blusa-07', 'Blusa Básica Aura Branca', 'blusas', 65.90, null, 'Branco', ['Branco', 'Rosa'], 'Essencial e fácil de combinar, é aquela peça curinga que funciona em diferentes propostas. Uma base clean para criar looks elegantes sem esforço.', 15, false, false),
  product('blusa-08', 'Blusa Laço Chiara Vinho', 'blusas', 139.90, 179.90, 'Vinho', ['Vinho', 'Preto'], 'O detalhe do laço acrescenta feminilidade e delicadeza à composição. Em vinho, ganha uma presença sofisticada e combina perfeitamente com produções especiais.', 0, false, false),
  product('blusa-09', 'Blusa Social Mirra Rosa', 'blusas', 229.90, 279.90, 'Rosa', ['Rosa', 'Bege'], 'A Blusa Social Mirra Rosa une delicadeza e elegância em uma proposta versátil. Ideal para produções refinadas, do ambiente profissional aos momentos especiais.', 1, false, true),
  product('calca-01', 'Calça Alfaiataria Ímpar Preto', 'calcas', 229.90, 299.90, 'Preto', ['Preto'], 'Sofisticação em uma peça clássica e indispensável. A alfaiataria preta permite criar produções elegantes e profissionais, além de combinações mais contemporâneas.', 2, true, true),
  product('calca-02', 'Calça Pantalona Sépia Marrom', 'calcas', 279.90, null, 'Marrom', ['Marrom'], 'A modelagem ampla proporciona movimento e uma silhueta elegante. O tom marrom traz sofisticação e personalidade para produções modernas.', 3, true, false),
  product('calca-03', 'Calça Reta Alba Preta', 'calcas', 189.90, 229.90, 'Preto', ['Preto'], 'Clássica, elegante e extremamente versátil. A modelagem reta cria uma proposta atemporal que combina facilmente com blusas, camisas e peças de alfaiataria.', 4, true, true),
  product('calca-04', 'Calça Cenoura Terracota', 'calcas', 169.90, null, 'Marrom', ['Marrom'], 'A modelagem cenoura traz um toque contemporâneo à produção, enquanto o terracota acrescenta personalidade. Uma escolha sofisticada para looks diferenciados.', 5, false, false),
  product('calca-05', 'Calça Flare Violeta', 'calcas', 349.90, 419.90, 'Vinho', ['Vinho'], 'Elegante e marcante, a modelagem flare valoriza a silhueta e cria um efeito alongado. A tonalidade violeta acrescenta personalidade ao look.', 6, false, true),
  product('calca-06', 'Calça Jogger Cora', 'calcas', 119.90, 149.90, 'Bege', ['Bege'], 'Moderna e descomplicada, combina uma proposta casual com uma tonalidade vibrante. Perfeita para produções leves e cheias de personalidade.', 7, false, false),
  product('calca-07', 'Calça Sarja ', 'calcas', 89.90, null, 'Branco', ['Branco'], 'Prática e versátil, é uma peça essencial para composições do dia a dia. Combina facilmente com diferentes estilos e permite criar produções descontraídas ou mais elaboradas.', 8, false, false),
  product('calca-08', 'Calça Clochard Siena', 'calcas', 219.90, 269.90, 'Marrom', ['Marrom'], 'A Calça Clochard Siena traz uma modelagem moderna e elegante, perfeita para quem gosta de peças diferenciadas. O design permite composições sofisticadas e contemporâneas.', 9, false, false),
  product('calca-09', 'Calça Reta Noite', 'calcas', 159.90, null, 'Preto', ['Preto'], 'Minimalista e atemporal, apresenta uma silhueta elegante e fácil de combinar. Uma peça indispensável para criar produções sofisticadas em qualquer ocasião.', 10, false, true)
];
